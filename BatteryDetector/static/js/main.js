function initBattery() {
    ...
    if (navigator.getBattery) {
        ...
        console.error("Battery Status API not supported in this browser. Please use a different browser or device.");
        // Provide alternative content or user notification
    }
}
